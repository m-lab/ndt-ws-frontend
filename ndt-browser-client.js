...
NDTjs.prototype.createWebsocket = function (serverAddress, serverPort,
                                            serverProtocol, urlPath,
                                            protocol) {
  var createdWebsocket = new WebSocket(serverProtocol + '://' + serverAddress +
...
NDTjs.prototype.startTest = function () {
  ...
  ndtSocket = this.createWebsocket(this.server, this.serverPort, this.serverProtocol, this.serverPath, 'ndt');
